...
import { bloodSeekersData, options } from './options'; // Adjust the import path as necessary
...
const Firstpage = ({ navigation }: NativeStackScreenProps<RootStackParamList, 'Firstpage'>) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Render the Blood Seekers */}
      <View style={styles.seekerContainer}>
        <View style={styles.headerContainer}>
          <Text style={styles.seekerTitle}>Blood Seekers</Text>
          <TouchableOpacity>
            <Text style={[styles.seeAllText, styles.seeAllSeekerList]}>See All</Text>
          </TouchableOpacity>
        </View>
        <FlatList
          data={bloodSeekers}
